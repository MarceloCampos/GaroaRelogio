 ...
 * - Parametros
 *   0 - hora atual (00 a 23)
 *   1 - minuto atual (00 a 59)
 *   2 - alarme (00 = desligado, 01 = ligado)
 *   3 - hora do alarme (00 a 23)
 *   4 - minuto do alarme (00 a 59)
 *   
 *   
 *   Rev 1 - 21/Mar/2021 
 *    - Inversão de níveis ativo p/ uso com Displays Cromatek CTK D4036ASR
 *    - Códigos de programação ~hora/ alm alterados para 0 à 4
 *   
 *   
 */
...
static void VarreDisp (void)
{
    ...
    segtos = segto[disp];
    digitalWrite (pinSegtoG, (segtos & 0x80) ? LOW : HIGH);
    digitalWrite (pinSegtoF, (segtos & 0x40) ? LOW : HIGH);
    digitalWrite (pinSegtoE, (segtos & 0x20) ? LOW : HIGH);
    digitalWrite (pinSegtoD, (segtos & 0x10) ? LOW : HIGH);
    digitalWrite (pinSegtoC, (segtos & 0x08) ? LOW : HIGH);
    digitalWrite (pinSegtoB, (segtos & 0x04) ? LOW : HIGH);
    digitalWrite (pinSegtoA, (segtos & 0x02) ? LOW : HIGH);
    digitalWrite (pinSegtoDP, (segtos & 0x01) ? LOW : HIGH);
